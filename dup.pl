...
if ($#ARGV == -1) {
	print "\n";
	print "This script identifies classes of conservation in an alignment of pre- and post-duplication sequences.\n";
	print "\nSyntax:\n";
	print " -f X		use file X as input\n";
	print " -clade_pre X	number of sequences in the pre-clade.\n";
	print " -clade_post1 X	number of sequences in the post1-clade.\n";
	
	print " -print_pos	print the individual positions of the main classes (c1,c2 and c1c2_diff).\n";
